...
public extension UICollectionView {
  ...
  */
  public func dequeueReusableCellWithReuseIdentifier<Identifier: ReuseIdentifierType>(_ identifier: Identifier, forIndexPath indexPath: IndexPath) -> Identifier.ReusableType? where Identifier.ReusableType: UICollectionReusableView {
  ...
  /**
   ...
   - returns: A subclass of UICollectionReusableView or nil if the cast fails.
  */
  public func dequeueReusableSupplementaryViewOfKind<Identifier: ReuseIdentifierType>(_ elementKind: String, withReuseIdentifier identifier: Identifier, forIndexPath indexPath: IndexPath) -> Identifier.ReusableType? where Identifier.ReusableType: UICollectionReusableView {
   ...
   */
  public func registerNibs<Resource: NibResourceType>(_ nibResources: [Resource]) where Resource: ReuseIdentifierType, Resource.ReusableType: UICollectionViewCell {
   ...
   */
  public func registerNib<Resource: NibResourceType>(_ nibResource: Resource) where Resource: ReuseIdentifierType, Resource.ReusableType: UICollectionViewCell {
   ...
   */
  public func registerNibs<Resource: NibResourceType>(_ nibResources: [Resource], forSupplementaryViewOfKind kind: String) where Resource: ReuseIdentifierType, Resource.ReusableType: UICollectionReusableView {
   ...
   */
  public func registerNib<Resource: NibResourceType>(_ nibResource: Resource, forSupplementaryViewOfKind kind: String) where Resource: ReuseIdentifierType, Resource.ReusableType: UICollectionReusableView {
